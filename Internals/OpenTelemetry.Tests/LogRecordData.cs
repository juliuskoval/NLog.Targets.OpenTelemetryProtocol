...
#pragma warning restore CA1815 // Override equals and operator equals on value types
{
    ...
    internal OpenTelemetry.Logs.LogRecordData ToDefaultLogRecordData()
    {
        return new OpenTelemetry.Logs.LogRecordData
        {
            ...
            Severity = LogRecordSeverityMapper.Map(this.Severity),
            Body = this.Body,
        };
    }
}

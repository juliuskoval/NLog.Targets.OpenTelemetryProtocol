...
#pragma warning restore CA1044 // Properties should not be write only
    ...
    internal OpenTelemetry.Logs.LogRecordAttributeList ToDefaultLogRecordAttributeList()
    {
        var attributes = new OpenTelemetry.Logs.LogRecordAttributeList();

        if (this.OverflowAttributes is not null)
        {
            foreach (var attribute in this.OverflowAttributes)
            {
